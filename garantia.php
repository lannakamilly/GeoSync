...
<head>
    ...
    <style>
        ...
        .list-style-accent li::before {
            ...
            width: 1.25rem; /* Ajuste para alinhamento */
        }
    </style>
 ...
 <nav class="bg-primary border-b border-gray-700 sticky top-0 z-40">
        ...
        <div id="mobile-menu" class="hidden md:hidden">
            <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 flex flex-col bg-gray-900 border-t border-gray-700">
                ...
                <a href="./produtos.php" class="block px-3 py-2 rounded-md text-base font-medium text-accent bg-gray-700 transition-colors">Produtos</a>
    ...
    <main class="flex-grow">
        <div class="gradient-bg py-16 border-b border-gray-700">
            <div class="max-w-7xl mx-auto px-6 text-center">
                ...
                <p class="text-xl text-gray-400 max-w-3xl mx-auto">Sua segurança é nossa prioridade. Conheça nossos termos para trocas, devoluções e cobertura da garantia.</p>
            </div>
        </div>
        ...
        <div class="max-w-4xl mx-auto px-6 py-16">
            ...
            <div class="mb-10">
                <a href="./produtos.php" class="inline-flex items-center px-6 py-3 bg-gray-800 rounded-xl font-bold text-lg border border-gray-700 hover:bg-accent hover:border-accent transition-all duration-300 transform hover:scale-[1.02]">
                    <i class="fas fa-arrow-left mr-3 text-white"></i> Voltar à Loja
                </a>
            </div>

            <section class="policy-section bg-gray-900 p-8 rounded-xl mb-12">
                <h2 class="text-3xl font-bold mb-5 text-accent border-b border-gray-700 pb-3">1. Direito de Arrependimento (Devolução)</h2>
                <p class="text-gray-300 mb-4 leading-relaxed">Conforme o Código de Defesa do Consumidor, você tem o prazo de <strong class="text-accent">7 (sete) dias corridos</strong>, a partir do recebimento do produto, para desistir da compra.</p>
                <ul class="list-style-accent ml-6 space-y-2 text-gray-300">
                    ...
                    <li>O produto deve ser devolvido na embalagem original, sem indícios de uso ou violação dos lacres.</li>
                    <li>O frete de devolução, nesse caso, é por nossa conta.</li>
                </ul>
            </section>

            <section class="policy-section bg-gray-900 p-8 rounded-xl mb-12">
                <h2 class="text-3xl font-bold mb-5 text-accent border-b border-gray-700 pb-3">2. Garantia por Defeito de Fabricação</h2>
                <p class="text-gray-300 mb-4 leading-relaxed">Todos os modelos de mochilas Geosync possuem uma garantia total de <strong class="text-accent">12 (doze) meses</strong> contra defeitos de fabricação (incluindo o módulo GPS/Tecnológico), contados a partir da data da Nota Fiscal.</p>
                <ul class="list-style-accent ml-6 space-y-2 text-gray-300">
                    <li>O prazo para acionar a garantia é de até 90 dias (CDC) e será estendido contratualmente pela Geosync até 12 meses.</li>
                    <li>Em caso de defeito, faremos a reparação ou a troca do produto por um novo, sem custos adicionais.</li>
                    <li>Danos causados por mau uso, quedas ou contato com água (se o modelo não for à prova d'água) não são cobertos pela garantia.</li>
                </ul>
            </section>

            <section class="policy-section bg-gray-900 p-8 rounded-xl mb-12">
                <h2 class="text-3xl font-bold mb-5 text-accent border-b border-gray-700 pb-3">3. Condições e Restituição de Valores</h2>
                <p class="text-gray-300 mb-4 leading-relaxed">Para iniciar qualquer processo de troca ou devolução, é fundamental que o produto esteja acompanhado da <strong class="text-accent">Nota Fiscal</strong>.</p>
                <div class="bg-gray-800 p-6 rounded-lg">
                    <h4 class="text-xl font-semibold mb-3 text-white">Reembolso</h4>
                    <ul class="list-style-accent ml-6 space-y-2 text-gray-300">
                        <li><strong>Cartão de Crédito:</strong> O estorno será solicitado à administradora do cartão em até 5 dias úteis após a análise do produto.</li>
                        <li><strong>PIX/Boleto:</strong> O reembolso será realizado via PIX ou transferência na conta do titular da compra em até 3 dias úteis.</li>
                    </ul>
                </div>
            </section>
            
            <p class="text-center text-lg text-gray-500 mt-10">Para mais informações ou iniciar um processo, entre em contato através do nosso chat de suporte.</p>
