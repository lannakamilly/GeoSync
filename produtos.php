            ...
            <div class="relative rounded-3xl overflow-hidden shadow-2xl border border-gray-700/50" style="height: 400px;"> 
                <div class="carousel-track absolute inset-0 flex transition-transform duration-700 ease-in-out">
                    ...
                    <div class="carousel-item-modern absolute inset-0 w-full h-full" data-index="1">
                        <img src="./imagens/banner2.png" alt="Kit Segurança Total Combo Família" class="w-full h-full object-cover">
                    ...
                    <div class="carousel-item-modern absolute inset-0 w-full h-full" data-index="3">
                        <img src="./imagens/banner1.jpeg" alt="Tecnologia de Localização Avançada" class="w-full h-full object-cover">
                ...
                <div class="grid lg:grid-cols-2 gap-12">
                    <div>
                        <div id="modal-main-image-container" class="h-96 rounded-xl mb-4 overflow-hidden shadow-xl border border-gray-700 bg-gray-800 flex items-center justify-center">
                            <img id="modal-main-image" src="" alt="Imagem principal do produto" class="w-full h-full object-cover transition-opacity duration-150 ease-in-out">
                        </div>
                    ...
                    <div>
                        ...
                        <div class="mb-8">
                            ...
                            <div class="flex space-x-3">
                                <button class="px-4 py-2 bg-gray-700 rounded-lg border border-gray-600 transition-colors hover:bg-accent text-sm">Pequeno</button>
                                <button class="px-4 py-2 bg-accent rounded-lg border border-accent text-white font-bold text-sm">Médio</button>
                                <button class="px-4 py-2 bg-gray-700 rounded-lg border border-gray-600 transition-colors hover:bg-accent text-sm">Grande</button>
                            </div>
                        </div>
